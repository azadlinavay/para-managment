...
import 'package:para/src/loggedInScreen/loggedInScreen.dart';
import 'package:para/src/registerScreen/registerScreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    if (_auth.currentUser != null) {
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(
          builder: (BuildContext context) => const LoggedInScreen(),
        ),
        (route) => false,
      );
    }
  ...
  Future login() async {
    ...
    var phoneNumber = '+964 ' + numberController.text.trim();
