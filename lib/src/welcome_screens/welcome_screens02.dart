...
class WelcomeScreenView02 extends StatelessWidget {
  const WelcomeScreenView02({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          ...
          Container(
              ...
              height: 320,
              child: Lottie.asset('assets/wellcome02.json')),
          Container(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(context, '/wellcome03');
                  },
                  child: const Text(
                    "Continue",
